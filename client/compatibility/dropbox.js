...
(function() {
  var DbxClient, DbxEnvGlobal, DbxEnvRequire, DbxXhrArrayBufferView, DbxXhrCanSendForms, DbxXhrDoesPreflight, DbxXhrIeMode, DbxXhrRequest, DbxXhrSendArrayBufferView, DbxXhrWrapBlob, Dropbox, error1,
  ...
  if (typeof Dropbox.Env.global.atob === 'function' && typeof Dropbox.Env.global.btoa === 'function') {
    ...
    Dropbox.Util.btoa = function(arg) {
      ...
      buffer = new Buffer((function() {
        var k, ref, results1;
        results1 = [];
        for (i = k = 0, ref = arg.length; 0 <= ref ? k < ref : k > ref; i = 0 <= ref ? ++k : --k) {
    ...
    (function() {
      ...
      Dropbox.Util.btoa = function(string) {
        var accumulator, bytes, i, k, ref, result;
        result = [];
        accumulator = 0;
        bytes = 0;
      ...
      return Dropbox.Util.atob = function(base64) {
        var accumulator, digit, digits, i, k, ref, result;
        result = [];
        accumulator = 0;
        digits = 0;
        for (i = k = 0, ref = base64.length; 0 <= ref ? k < ref : k > ref; i = 0 <= ref ? ++k : --k) {
